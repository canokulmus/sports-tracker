...
class TestGame:
    ...
    def test_game_creation(self, game, teams):
    ...
    def test_game_start(self, game, capsys):
    ...
    def test_game_start_twice(self, game, capsys):
    ...
    def test_game_pause(self, game, capsys):
        """Test pausing a game."""
        game.start()
        game.pause()
        captured = capsys.readouterr()
    ...
    def test_game_resume(self, game, capsys):
    ...
    def test_game_end(self, game, capsys):
        """Test ending a game."""
        game.start()
        game.end()
        captured = capsys.readouterr()
    ...
    def test_score_when_running(self, game, teams, capsys):
    ...
    def test_score_when_not_running(self, game, teams, capsys):
    ...
    def test_score_both_teams(self, game, teams):
    ...
    def test_player_score_tracking(self, game, teams):
    ...
    def test_timeline_tracking(self, game, teams):
    ...
    def test_stats_ready_state(self, game):
    ...
    def test_stats_after_end(self, game, teams):
    ...
    def test_observer_pattern(self, game):
    ...
    def test_unwatch_observer(self, game):
