...
class TestCupLeague:
    ...
    def test_league_creation(self, teams):
    ...
    def test_league2_creation(self, teams):
    ...
    def test_search_all_games(self, teams):
    ...
    def test_search_by_team(self, teams):
    ...
    def test_getitem_invalid_id(self, teams):
    ...
    def test_league_standings_no_games(self, teams):
        ...
        for _, won, draw, lost, gf, ga, pts in standings:
            assert won == 0
            assert draw == 0
            assert lost == 0
            assert gf == 0
    ...
    def test_league_standings_after_games(self, teams):
        ...
        winner_name = game1.home().team_name
        winner_standing = next(s for s in standings if s[0] == winner_name)
        _, won, draw, lost, gf, ga, pts = winner_standing
    ...
    def test_watch_observer(self, teams):
...
class TestCupElimination:
    ...
    def test_elimination_creation(self, teams):
    ...
    def test_elimination_rounds(self, teams):
    ...
    def test_elimination2_double_games(self):
    ...
    def test_elimination_standings(self):
        ...
        for team_name, info in standings.items():
            if len(info['Won']) == 1:
                assert info['Round'] == 1
                assert info['Lost'] is None
    
    def test_gametree_elimination(self, teams):
...
class TestCupGroup:
    ...
    def test_group_creation(self, teams):
    ...
    def test_group_games(self, teams):
    ...
    def test_group_standings(self, teams):
        ...
        assert "Playoffs" in standings
        
        # Should have 4 groups
        assert len(standings["Groups"]) == 4
    
    def test_group_gametree(self, teams):
        ...
        assert "Playoffs" in tree
        
        # Should have 4 groups
        assert len(tree["Groups"]) == 4


class TestCupErrors:
    """Test error handling in Cup class."""
    
    def test_gametree_wrong_type(self):
