...
class TestRepo:
    ...
    def test_create_team(self, repo):
    ...
    def test_create_multiple_objects(self, repo):
    ...
    def test_create_invalid_type(self, repo):
        """Test creating object with invalid type."""
        with pytest.raises(ValueError):
            repo.create(type="invalid_type")
    
    def test_create_without_type(self, repo):
    ...
    def test_list_objects(self, repo):
    ...
    def test_attach_multiple_users(self, repo):
    ...
    def test_attach_default_user(self, repo):
    ...
    def test_detach_multiple_users(self, repo):
    ...
    def test_delete_unattached(self, repo):
    ...
    def test_delete_attached_fails(self, repo):
    ...
    def test_delete_after_detach(self, repo):
    ...
    def test_listattached_empty(self, repo):
    ...
    def test_listattached_single_user(self, repo):
    ...
    def test_listattached_multiple_users(self, repo):
    ...
    def test_listattached_after_detach(self, repo):
    ...
    def test_workflow_scenario(self, repo):
